...
namespace ApiQuanLyNhaThuoc.DataAccess.Migrations
{
    ...
    [Migration("20241118170205_addGhiChuTimeLine")]
    partial class addGhiChuTimeLine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApiQuanLyNhaThuoc.Models.Entities.DanhMuc", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "DM111",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3138),
                            MoTa = "Thuốc dị ứng",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3151),
                            TenDanhMuc = "Thuốc"
                        },
                        new
                        {
                            Id = "DM112",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3153),
                            MoTa = "Thuốc da liễu",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3153),
                            TenDanhMuc = "Thuốc"
                        },
                        new
                        {
                            Id = "DM113",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3154),
                            MoTa = "Thuốc hô hấp",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3155),
                            TenDanhMuc = "Thuốc"
                        },
                        new
                        {
                            Id = "DM114",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3156),
                            MoTa = "Vitamin & Khoáng chất",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3156),
                            TenDanhMuc = "Thực phẩm chứng năng"
                        },
                        new
                        {
                            Id = "DM115",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3157),
                            MoTa = "Hỗ trợ làm đẹp",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3158),
                            TenDanhMuc = "Thực phẩm chứng năng"
                        },
                        new
                        {
                            Id = "DM116",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3159),
                            MoTa = "Dinh dưỡng",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3159),
                            TenDanhMuc = "Thực phẩm chứng năng"
                        });
                });
            ...
            modelBuilder.Entity("ApiQuanLyNhaThuoc.Models.Entities.NhaCungCap", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "NCC001",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3345),
                            DiaChi = "123 Lê Lợi",
                            Email = "longchaugv@gmail.com",
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3346),
                            QuocGia = "Việt Nam",
            ...
            modelBuilder.Entity("ApiQuanLyNhaThuoc.Models.Models.Entities.KhoHang", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "KHO001",
                            CreatedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3378),
                            ModifiedDate = new DateTime(2024, 11, 19, 0, 2, 3, 435, DateTimeKind.Local).AddTicks(3379),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7a4f5560-3d5d-43d1-a9f9-83a16116463c",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "b8792241-f983-4ea4-a8d6-f9039b70a88e",
                            Name = "Employee POS",
                            NormalizedName = "EMPLOYEE POS"
                        },
                        new
                        {
                            Id = "d60e0cc2-1725-471a-9951-381e5c00106b",
                            Name = "Employee Manager",
                            NormalizedName = "EMPLOYEE MANAGER"
                        },
                        new
                        {
                            Id = "ac90ad12-7535-4ac1-8def-97e195a1c958",
                            Name = "Employee Online",
                            NormalizedName = "EMPLOYEE ONLINE"
                        },
                        new
                        {
                            Id = "85fc3549-92f3-44fd-a3e0-1b284c4a19d7",
                            Name = "Customer",
