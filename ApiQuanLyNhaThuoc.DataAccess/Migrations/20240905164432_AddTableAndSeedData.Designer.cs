...
namespace ApiQuanLyNhaThuoc.DataAccess.Migrations
{
    ...
    [Migration("20240905164432_AddTableAndSeedData")]
            ...
            modelBuilder.Entity("ApiQuanLyNhaThuoc.Models.Entities.DanhMuc", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("585e1032-5a9e-4e1f-a64e-df0e7809cd6f"),
                            CreatedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9744),
                            MoTa = "Thuốc dị ứng",
                            ModifiedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9755),
                            TenDanhMuc = "Thuốc"
                        },
                        new
                        {
                            Id = new Guid("d9cad089-989d-422a-b8a9-3d3605b794d2"),
                            CreatedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9758),
                            MoTa = "Thuốc da liễu",
                            ModifiedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9759),
                            TenDanhMuc = "Thuốc"
                        },
                        new
                        {
                            Id = new Guid("cf9e9154-c5b2-4fa5-9abc-20957f368e6f"),
                            CreatedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9771),
                            MoTa = "Thuốc hô hấp",
                            ModifiedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9772),
                            TenDanhMuc = "Thuốc"
                        },
                        new
                        {
                            Id = new Guid("9bc2e6c2-bdde-424a-bee8-d602c3f4f8a0"),
                            CreatedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9774),
                            MoTa = "Vitamin & Khoáng chất",
                            ModifiedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9774),
                            TenDanhMuc = "Thực phẩm chứng năng"
                        },
                        new
                        {
                            Id = new Guid("c7aaec50-473c-43aa-b41a-65fe2a9bd944"),
                            CreatedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9776),
                            MoTa = "Hỗ trợ làm đẹp",
                            ModifiedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9776),
                            TenDanhMuc = "Thực phẩm chứng năng"
                        },
                        new
                        {
                            Id = new Guid("d5934ba7-6337-4bfb-bf42-f6034ea58e1a"),
                            CreatedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9778),
                            MoTa = "Dinh dưỡng",
                            ModifiedDate = new DateTime(2024, 9, 5, 23, 44, 31, 671, DateTimeKind.Local).AddTicks(9779),
                            TenDanhMuc = "Thực phẩm chứng năng"
                        });
                });
